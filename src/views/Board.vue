        ...
        <div class="row">
            <div class="col-xl-4 col-md-6">
                <div class="card bg-white text-dark mb-4">
                    <div class="card-header d-flex">
                        ...
                        <div class="col-md-3">
                            <router-link class="btn btn-primary btn-sm" :to="'/mission/' + mission.missionId + '/board/create'">미션 수행하기</router-link>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="w-100">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="80%">{{mission.missionGoal}}</td>
                                </tr>
                                <tr>
            ...
            <div class="row" v-if="boardList.length > 0">
                <a class="col-xl-12" href="#" v-for="board in boardList" v-bind:key="board.boardId" @click="goToBoardInfo(board.boardId)">
                    <div class="card mb-4">
                        <div class="card-header d-flex">
                            <div class="col-md-10"><font-awesome-icon :icon="['fas', 'clone']" class="mx-3"/>{{mission.missionTitle}}</div>
